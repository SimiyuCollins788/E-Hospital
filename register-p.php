		...
		<div class='row'>
			...
			<div class='col-md-7'>
				...
				<div class='content-header'> 
					Patient Registration <small>New patient only? Register here</small>
				</div>
				<?php require_once "inc/alerts.inc.php";  ?> 
				<div class='content-body'>
					<div class='form-holder' style='margin-top: 5px;'>
					    <div class='badge-header'>Your Details</div>
						<?php Messages::info("Patient <strong>Number</strong> Is System generated, <strong>Note!</strong> it somewhere for <strong>Login</strong> purpose"); ?>
						<?php

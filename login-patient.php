		...
		<div class='row'>
			...
			<div class='col-md-7'>
				...
				<div class='content-header'> 
					Patient's Data <small>Access and download your data <!-- Or <a href='register-p.php'>Register Here --></a> </small>
					
				</div>
				<div class='content-body'>
					<div class='form-holder'><br /><br />
					<?php Messages::info("Not Registered? Request for <strong>Patient Number </strong> <a href='enquiry.php'>Here</a>"); ?>
						<?php 
							$phone = ""; 
							$number = "";
